...
\item start a TDAC analysis which allows to choose a desire target threshold. During this phase a tool tries to assign the optimized value of TDAC at each pixel in several steps, in order to get as close as possible to the set threshold. At the end it returns a map of the final TDAC values for all selected pixels.
...
{\includegraphics[scale=0.35]{tdac_map}}\quad
\subfigure[Threshold map of tuned Cascode FE]
{\includegraphics[scale=0.55]{th_map_tuned}}\quad
