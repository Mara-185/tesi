...
\subsection{Hot pixel issue and strategy?}

%VEDI SCREEN DI SLIDE 1. -----> INTRO DEL PROBLEMA
% Explain why we can see hot pixel in HV and not other with TB SETTING, TIED TO THR.
%
