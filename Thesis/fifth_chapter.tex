...
\hline
\ch{^{241}Am} & 13.9 & 60\\[0.5ex]
\hline
\ch{^{241}Am} & 17.7 & 100\\[0.5ex]
\hline
\ch{^{241}Am} & 20.7 & 8\\[0.5ex]
\hline
\ch{^{109}Cd} & 22 &40\\[0.5ex]
\hline
\ch{^{241}Am} & 26.4 & 228\\[0.5ex]
\hline
\ch{^{241}Am} & 59.7 & 100\\
\hline
\end{tabular}
...
The third source employed was the \ch{^{109}Cd}. In its spectrum a peak at 22 KeV is expected. In figure \vref{cd_all} the results obtained irradiating all FE.
