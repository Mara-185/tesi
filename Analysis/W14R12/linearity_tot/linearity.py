...
if __name__ == "__main__":
    ...
    for (a,b,c,t,name), p,thr, dac, point in zip(FRONTENDS_PARAM_NO, FRONTENDS_PEAK, FRONTENDS_PARAM_TH, FRONTENDS_DAC2, MARKER):
        print(dac)
        print(p)
        print(thr)
        print(a, b, c, t)
