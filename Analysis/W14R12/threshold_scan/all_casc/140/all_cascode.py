...
###################################################
        ...
        pdf.savefig();
        plt.savefig("threshold_map_casc_140.png"); plt.clf()


        # THRESHOLD MAP SAME SCALE OF NORMAL
        plt.axes((0.125, 0.11, 0.775, 0.72))
        plt.pcolormesh(occupancy_edges[0], occupancy_edges[1], threshold_DAC.transpose(),
                       rasterized=True)  # Necessary for quick save and view in PDF
        plt.title(subtitle)
        ...
        frontend_names_on_top()
        pdf.savefig();
        plt.savefig("threshold_map_casc_140_lim1.png"); plt.clf()
        ...
        frontend_names_on_top()
        pdf.savefig();
        plt.savefig("threshold_map_casc_140_lim2.png"); plt.clf()
        ...
        frontend_names_on_top()
        pdf.savefig();
        plt.savefig("threshold_map_casc_140_lim3.png"); plt.clf()
        ...
        frontend_names_on_top()
        pdf.savefig();
        plt.savefig("threshold_map_casc_140_lim4.png"); plt.clf()
        ...
        plt.legend()
        pdf.savefig();
        plt.savefig("Noise_hist_casc_140.png"); plt.clf()
...
###################################################
        ...
        plt.legend()
        pdf.savefig();
        plt.savefig("Noise_hist_casc_140_fit.png"); plt.clf()
        ...
        frontend_names_on_top()
        pdf.savefig();
        plt.savefig("Noise_map_casc_140.png"); plt.clf()

        # NOISE MAP LIM (1.75-4)
        plt.axes((0.125, 0.11, 0.775, 0.72))
        plt.pcolormesh(occupancy_edges[0], occupancy_edges[1], noise_DAC.transpose(),
                       rasterized=True)  # Necessary for quick save and view in PDF
        plt.title(subtitle)
        ...
        frontend_names_on_top()
        pdf.savefig();
        plt.savefig("Noise_map_casc_140_lim.png"); plt.clf()


        #Noise map with cut
        noise_DAC[noise_DAC>4] = 0
        ...
        frontend_names_on_top()
        pdf.savefig();
        plt.savefig("Noise_map_casc_140_cut(4).png"); plt.clf()


        # Noise Hist Fit with cut
        for i, (fc, lc, name) in enumerate(FRONTENDS):
            if fc >= col_stop or lc < col_start:
                continue
            fc = max(0, fc - col_start)
        ...
        plt.legend()
        pdf.savefig();
        plt.savefig("Noise_hist_casc_140_fit_cut(4).png"); plt.clf()
