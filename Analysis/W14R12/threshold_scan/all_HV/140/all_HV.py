...
###################################################
        ...
        for i, (fc, lc, name) in enumerate(FRONTENDS):
            ...
            pdf.savefig();
            plt.savefig(f"threshold_map_{name}_140.png"); plt.clf()
        ...
        for i, (fc, lc, name) in enumerate(FRONTENDS):
            ...
            plt.xlim([0.1,6])
            pdf.savefig();
            plt.savefig(f"Noise_hist_{name}_140.png"); plt.clf()
...
##############################################
            ...
            popt_noise, pcov_noise = curve_fit(gauss, bin_center_noise, bin_height_noise, p0=[3000, 1, 0.05])
            print(*popt_noise)
